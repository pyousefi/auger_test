...
def run_iris_train():
    ...
    client = AugerClient(AugerConfig(config_dir="./give_me_some_credit",
    ...
    result = experiments.predict_by_file(client, pipeline_id=pipeline_id, file='./iris_train/files/iris.csv', save_to_file=False)
    print(result[0])
